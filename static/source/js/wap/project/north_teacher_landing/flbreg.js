...
$(".teacherYear").blur(function(){
	...
	if(teacherYear=="Select" || teacherYear==""){
		$(this).next(".fr_tip7").html("Please fill out your Years of Teaching.");
		return false;
	}
});
$(".experience").blur(function(){
	...
	if(experience=="Select" || experience==""){
		$(this).next(".fr_tip7").html("Please fill out your Kids Teaching Experience.");
		return false;
	}
});
...
$("#appDate").blur(function(){
	...
	if(!appDate){
		$(this).next(".fr_tip7").html("Please fill out your Preferred Interview Date.");
		return false;
	}else{
		$(this).next(".fr_tip7").html("");
	}
...
$("#interview_times").blur(function(){
	...
	if(tmp_season=="-1" || tmp_season==""){
		$("#d").next(".fr_tip8").html("Please fill out your Preferred Interview Time.");
		return false;
	}
});
//form验证
	$("#fr_submit").on("click",function(){
			...
			if(first_name==""){
				...
				$(".experience").next(".fr_tip7").html("Please fill out your Kids Teaching Experience.");
				return false;
			}else if(appDate ==""){
				$("#appDate").next(".fr_tip7").html("Please fill out your Preferred Interview Date.");
				return false;
			}else if(tmp_season=="-1" || tmp_season==""){
				$("#d").next(".fr_tip8").html("Please fill out your Preferred Interview Time.");
				return false;
			}else if((experience==16 || experience==17) && (teacherYear=="" || teacherYear=="Select")){
				$(".teacherYear").next(".fr_tip8").html("Please fill out your Preferred Interview Time.");
				return false;
			}
			$.ajax({
