define("app_payIntroduce1v3",["fastclick","swiper-3.3.1.jquery.min"],function(require, exports, module) {
...
//套餐
    ...
    $to_pay_on_pop_car.on("click",function(){
        ...
        $class_to_buy.animate({bottom:"-10rem"},1);
        $(".pay-dialog").show();
    });
