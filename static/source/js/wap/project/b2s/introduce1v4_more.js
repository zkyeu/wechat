define("introduce1v4_more",["fastclick","swiper-3.3.1.jquery.min","utility"],function(require, exports, module) {
    ...
    var bottom_box = $(".bottom_box"),
       ...
       var isclick = false; //判断是否在倒计时过程中点击了购买 如果点击暂不显示倒计时弹窗
