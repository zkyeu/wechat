define("app_marketing_2", ["fastclick", "utility", "swiper-3.3.1.jquery.min"], function(require, exports, module) {
    require("fastclick");
    ...
    (function() {
        ...
        if(isAndroid){
            ...
            $(".js_input").on("focus","",function(){
                ...
                if(dialogTopIsUse == 1){
                    ...
                    dialogTopIsUse = 0;
                    // js_dialog_con.css({"top": 0-(_this.parents(".js_dialog_con").find(".js_input_firstTop").offset().top - $(window).scrollTop() - dialogTop -15)});
                    js_dialog_con.css({"top": -80});
                    window.dialogTimer = setInterval(function(){
                        var nowwindowHeight = $(window).height();
                        if(windowHeight - nowwindowHeight > 100){
                            //软键盘出来了
                        }else{
                            //软键盘回去了
            ...
            $(".js_input").on("blur","",function(){
                ...
                setTimeout(function(){
                    ...
                    if(num == 0){
                        js_dialog_con.css({"top": dialogTop});
                        dialogTopIsUse = 1;
                        clearInterval(window.dialogTimer);
                    }
                },200)
            })
        }
        ...
        js_select.on("click", "", function() {
            var ajaxurl = js_select.data("ajaxurl"),
                ...
                active_type = js_select.data("activetype");
