define("1v1_pay_course", [""], function(require, exports, module) {
    ...
    (function() {
        ...
        if (endTime == 0) {
            js_countDown_btn1.text('立即查看');
            js_countDown_wrap.addClass('disnone');
            js_valuePack.removeClass('disnone');
            js_valuePack.text("本期招生未开始，招生开始前我们将及时通知，感谢您的耐心。");
        ...
        function write() {
            ...
            if (fromStart >= 0) {
                ...
                js_countDown_btn1.text('立即报名');
                js_countDown_wrap.removeClass('disnone');
                js_valuePack.addClass('disnone');
                ...
                js_countDown_wrap.addClass('disnone');
                js_valuePack.removeClass('disnone');
                js_valuePack.text("本期招生已结束，请关注无忧课堂APP、班级家长群、服务号的新一期招生信息。");
                js_price.text(unknownPrice);
            }
        }
