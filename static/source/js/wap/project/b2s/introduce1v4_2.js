define("introduce1v4_2",["fastclick","swiper-3.3.1.jquery.min"],function(require, exports, module) {
...
//有弹框后禁止滑动
    ...
    //年级切换
    var first_title = $(".first_title"),
        content = $(".content");
    first_title.on("click","li",function(){
        var index = $(this).index();
        var  that = $(this);
        that.addClass("active").siblings().removeClass("active");
        content.find("li").eq(index).removeClass("disnone").siblings().addClass("disnone");
    });
