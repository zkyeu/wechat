...
define(function(require, exports, module) {
    ...
    $('#j_submit_btn').click(function() {
        var student_name = $('#j_apply_form input[name="student_name"]').val();
        var province = $('#j_apply_form #s_province').val();
        var city = $('#j_apply_form #s_city').val();
        var grade = $('#j_grade_select .class-active').attr('data-val');
        if(sta==true){
            alert("请勿频繁提交！");
            return false;
        }
    ...
    // 推荐年级
    $('#j_grade_select').on('click', '.li-content', function() {
        $(this).addClass("class-active").siblings('.li-content').removeClass('class-active');
    });
