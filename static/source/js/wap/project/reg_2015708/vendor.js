...
define('multiselector',['mask'], function(require,exports){
	var mask = require('mask');
	/**
	...
	function multiSelector(opt){
		var option = {
			complete:function(){},//完成 按钮回调
			cancel:function(){},//cancel 按钮回调
			tonow:function(){}, //至今 按钮回调
			notonow:false,//不显示至今 按钮
			val:'-'
		};
		...
		var basestr = '<div class="js-date-select">'+
			'	<div class="btn-group">'+
			'		<a class="btn lf cancel-btn"  href="javascript:;">取消</a>'+
			'		<a class="btn tonow-btn" href="javascript:;">至今</a>'+
			'		<a class="btn rt complete-btn" href="javascript:;">完成</a>'+
			'	</div>'+

			'	<div class="select-con-all">'+
				'	<div class="select-con">'+
				'		<ul class="con-year"></ul>'+
				'		<ul class="con-month"></ul>'+
