...
define(function(require,exports,module){
	...
	$(".free").click(function(){
		...
		if($("#register_from").val()=='3744212'){
			_hmt.push(['_trackEvent','51talk_01','click','share']);
		}else if($("#register_from").val()=='4141201'){
			_hmt.push(['_trackEvent','51talk_02','click','share']);
		}else if($("#register_from").val()=='4141202'){
			_hmt.push(['_trackEvent','51talk_03','click','share']);
		}else if($("#register_from").val()=='4141203'){
			_hmt.push(['_trackEvent','51talk_04','click','share']);
		}
