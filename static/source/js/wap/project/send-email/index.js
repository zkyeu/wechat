...
define(function(require,exports,module){
	var provinceVal = $("#s_province").attr("data-value");
	var cityVal = $("#s_city").attr("data-value");
	if(provinceVal!=""){
		$("#s_province option").eq(0).val(provinceVal).html(provinceVal);
	};
	if(cityVal!=""){
		$("#s_city option").eq(0).val(cityVal).html(cityVal);
	};
	...
	$(".regbtn").on("click",function(){
		...
		var sProvince = $("#s_province option:selected").val();
		var sCity = $("#s_city option:selected").val();
		var teleRe = /^1[0-9]{10}$/;
		var passwordRe = /^\w+$/;
		if(!nickname){
			alert("请输入您的名称");
		...
		$.post("/Ajax/youthMail",{pick_name:nickname,mobile:tele,address:address,"user_id":userId,"province":sProvince,"city":sCity},function(res){
