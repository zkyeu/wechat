    ...
    adminNew.vm = new Vue({
        ...
        methods : {
            ...
            keywordDataSure : function(){
                ...
                // console.log(JSON.stringify(keywordData));
                // console.log(adminNew.keyword_id,that.keywordData.resultArr);
                // console.log($.inArray(adminNew.keyword_id,that.keywordData.resultArr) > -1);
                // return;
                adminNew.doAjax({
