define("weixinFace",[],function(require,exports,module){
	...
	;(function(){
		...
		for(var i=0,l=qqfaceConfigArr.length;i<l;i++){
			...
			qqfaceRegArr.push("\\"+e.slice(0,-1)+"\\"+e.slice(-1));
			faceConfig[e] = String(i);
		}

		var qqfaceReg = new RegExp(qqfaceRegArr.join("|"), "g");

		exports.getQQFace = function(str){
			return str.replace(qqfaceReg,function(e){
