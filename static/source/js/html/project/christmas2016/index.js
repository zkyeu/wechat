...
//判断浏览器是否支持 placeholder属性  
    ...
    // 名师列表悬停
    $(".pri-list02 .m-list>li img").hover(function(){
        $(this).parent().find(".m-list01-ul").stop(true,true).slideDown(300);
    },function(){
        $(this).parent().find(".m-list01-ul").stop(true,true).slideUp(300);
    })
});
