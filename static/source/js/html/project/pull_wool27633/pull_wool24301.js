   ...
   //判断浏览器是否支持 placeholder属性  
    ...
    function setfoc(count) {
      ...
      switch(count) {
        ...
        case 3:
          ...
          $(".nav li").eq(3).addClass("wechatSpHover");
          break;
        case 4:
          $(".nav li").eq(3).removeClass("wechatSpHover");
    ...
    // var shareContent = "51Talk送福利，邀你和好友一起玩转英语。";
   var sTitle = $(".container").attr("data-qqweibo_title");
   var shareContent = sTitle || "51Talk送福利，邀你和好友一起玩转英语。";
   var dbDesc = "aasdfasdfasdfas";
   var shareLink = $(".container").attr("data-url");
    ...
    !function() {
        $(".chatWindow").on("click",function(){
              ...
              var iframe = $('#bdshare_weixin_qrcode_dialog_qr');
              if(iframe.length==1){
                  var erwei=$("#erwei");
                  clearInterval(timer);
...
/*2016.10.11*/ 
$(".reward .r-ls").click(function(){
  $(".p-layer").show(); 
});
$(".p-layer .r-hov").click(function(){
  $(".p-layer").hide();
});
